...
useEffect(() => {
  ...
  return (
    <div className={styles.container}>
      ...
      <h2 className={styles.tokenLabel1} style={{ fontFamily: 'VT323, monospace' }}>POLYWATCH STAKING</h2>
      ...
      {!address ? (
        ...
        <>
          <h2 className={styles.tokenLabel} style={{ fontFamily: 'VT323, monospace' }}>YOUR TOKENS</h2>
            <div className={styles.tokenGrid}>
            <div className={styles.tokenItem}>
            <h2 className={styles.tokenLabel} style={{ fontFamily: 'VT323, monospace' }}>Claimable Rewards</h2>
  ...
  style={{
    marginLeft: "auto", // Centra il pulsante orizzontalmente
    marginRight: "auto",
    marginTop: "20px",
    background: "#6600FF", // Imposta lo sfondo viola
    border: "none", // Rimuovi il bordo
    color: "#FFFFFF", // Imposta il testo in bianco
    textAlign: "center",
    fontSize: "14px",
    fontWeight: "bold",
...
<hr className={`${styles.divider} ${styles.spacerTop}`} />
          <h2 className={styles.tokenLabel} style={{ fontFamily: 'VT323, monospace' }}>YOUR UNSTAKED POLYWATCH</h2>
